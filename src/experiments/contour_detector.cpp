/* contour_detector.cpp -- Experiment which thresholds on hue
...
int main(int argc, char *argv[])
{
	...
	cv::Mat thresholded;
	cv::threshold(img.hue, hsv_thresh_hue_lower, atoi(argv[2]), 255,
		      cv::THRESH_BINARY);
	cv::threshold(img.hue, hsv_thresh_hue_upper, atoi(argv[3]), 255,
