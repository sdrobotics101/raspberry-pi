...
void Robot::teleop_periodic()
{
	...
	if (input.find(" ") == std::string::npos) {
		if (input == "mag_x")
			...
			std::cout << std::
			    right << std::setw(14) << "lin  " << std::
			    left << std::setw(8) << "UINT16" << std::setw(0) <<
			    "set linear loop control" << std::endl;
			std::cout << std::
			    right << std::setw(14) << "rot  " << std::
			    left << std::setw(8) << "UINT8" << std::setw(0) <<
			    "set rotational loop control" << std::endl;
			std::cout << std::
			    right << std::setw(14) << "dep  " << std::
			    left << std::setw(8) << "UINT8" << std::setw(0) <<
			    "set depth loop control" << std::endl;
			std::cout << std::
			    right << std::setw(14) << "stb  " << std::
			    left << std::setw(8) << "UINT8" << std::setw(0) <<
			    "set stabilization loop control" << std::endl;
			std::cout << std::
			    right << std::setw(14) << "cs  " << std::
			    left << std::setw(8) << "UINT8" << std::setw(0) <<
			    "set pid coefficients" << std::endl;
			std::cout << std::
